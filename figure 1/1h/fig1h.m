...
randDistMedian = nan(size(finalDistStore,1),1);
for iExp = 1:size(finalDistStore,1)
    randDist = nanmean(finalDistStore{iExp,1},2);
    randDistMedian(iExp,1) = nanmedian(randDist);
end

%%
randDist = randDistMedian;
