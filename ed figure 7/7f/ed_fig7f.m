load expList_MEC_26718_diffRms
load rotCCstore_26718_rmPair1
numMods = size(rotCCstore,4);
mxStoreRmPair1 = mxStore;
...
%%
cnt = 2;
load rotCCstore_26718_rmPair2
mxStoreRmPair2 = mxStore;
mindStore2 = mindStore;
...
%% repeat AxB at the rotation of AxC
load rotCCstore_26718_rmPair1
numMods = size(rotCCstore,4);
mxStoreRmPair1 = mxStore;
mindStore = mindStore2;
...
for iMod = 1:numMods
    ...
    plot(1:120,mxStoreRmPair1(iMod,:),'-','color',colorMapLight(iMod,:))
    hold on
    plot(1:120,mxStoreRmPair2(iMod,:),'-','color',colorMap(iMod,:))
    ylabel('Correlation')
